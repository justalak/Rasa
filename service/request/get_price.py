...
class RequestPrice:
    ...
    def CurrentPrice(symbol):
        ...
        if current_date.isoweekday() == 6:
            ...
            return RequestPrice.loadJson(symbol, yesterday.strftime("%Y-%m-%d"), yesterday.strftime("%Y-%m-%d"))
        else:
    ...
    def PriceInQuarter(symbol):
        return RequestPrice.PriceInPeriodOfDays(symbol, 30 * 4)

    @staticmethod
    def PriceInSixMonths(symbol):
        return RequestPrice.PriceInPeriodOfDays(symbol, 30 * 6)

    @staticmethod
    def PriceInYear(symbol):
        return RequestPrice.PriceInPeriodOfDays(symbol, 365)
    #
    # @staticmethod
